    ...
    <div class="grid_12">
        <nav class="horizontal-nav full-width horizontalNav-notprocessed">
            <ul class="sf-menu">
                   ...
                   <li class="current "><a href="admin_requests.jsp">User Requests</a></li>
 ...
 <div class="content">
   <div class="container_12">
    <div class="grid_12 page">
       ...
       <p><center><font size="35" color="black">View User Requests </font></center></p><br/>
   <style>
        th{
            color: #50aac3;
        }
...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <th><font color="black"><%=rs.getString(9)%></th>
                <td><a href="admin_requests1.jsp?id=<%=rs.getInt(1)%>&companyname=<%=rs.getString("companyname")%>&email=<%=rs.getString("email")%>&drive=<%=rs.getString("drive")%>&department=<%=rs.getString("department")%>&address=<%=rs.getString("address")%>&mobile=<%=rs.getString("mobile")%>&user=<%=rs.getString(8)%>"><font color="#0d637d" size="3">Accept</font></a> </td>
